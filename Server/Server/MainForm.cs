    ...
    public partial class MainForm : Form
    {
        ...
        private void connectToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (!connected)
            {
                ...
                int rnd = 1025 + new Random().Next(1000);
                for (imgport = rnd; (imgport < 65535) && (Array.Find(tcpConnInfoArray, comparePort) != null); ++imgport) ;
        ...
        private void updateLog(string strMessage)
        {
            ...
            // se e' un messaggio di Chat (contiene "USER says: MESSAGE") coloro USER e MESSAGE
            string search = " says: ";
            int pos = 0;
